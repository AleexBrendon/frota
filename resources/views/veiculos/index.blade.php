        ...
        <div class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
            <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                <div class="flex items-center justify-between ">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-800">Veículos</h3>
                        <p class="text-slate-500">Veículos cadastrados!</p>
                    </div>
                    <div class="shrink-0">
                ...
                <table class="w-full mt-4 text-left table-auto min-w-max">
                    <thead>
                        <tr>
                            ...
                            <th
                                class="p-4 transition-colors cursor-pointer border-y border-slate-200 bg-slate-50 hover:bg-slate-100">
                                <p
                                    class="flex items-center justify-center gap-2 font-sans text-sm  font-normal leading-none text-slate-500">
                                    Opções
                                </p>
                            </th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="grid grid-flow-col grid-rows-2 justify-center">
                                <div>
